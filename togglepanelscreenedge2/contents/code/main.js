...
var togglePanel = function() {
    ...
    var plasmascript = "panel = panelById(panelIds[2]); panel.height = panel.height * -1; if (panel.location == 'left') {panel.location = 'right'; sleep(10); panel.location = 'left';} if (panel.location == 'top') {panel.location = 'bottum'; sleep(10); panel.location = 'top';} if (panel.location == 'right') {panel.location = 'left'; sleep(10); panel.location = 'right';} if (panel.location == 'bottum') {panel.location = 'top'; sleep(10); panel.location = 'bottum'; } ";
